...
- **EcoCity Dashboard** – View total points, activity history, and impact summaries.
- **Rewards Concept** – EcoCity can be exchanged for benefits such as discounts or event access (demo-based).
...
- Focuses on **students and campus environments** for realistic adoption.
...
- Scalable with:
  ...
  - Smart recycling verification
  - Partnerships with local businesses or municipalities
