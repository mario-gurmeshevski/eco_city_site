...
export function Home({ points, activities, impact, onNavigate }: HomeProps) {
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="text-center py-4">
        ...
        <p className="text-gray-600 mt-2">Making the planet greener, one action at a time</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-2xl">🚌</span>
            <p className="text-orange-900">Trips</p>
          </div>
          <p className="text-orange-600">{impact.tripsCount}</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="bg-white border border-gray-200 rounded-xl p-4 hover:border-green-500 hover:shadow-md transition-all"
          >
      ...
      <div>
        ...
        {recentActivities.length === 0 ? (
          <div className="bg-gray-50 rounded-xl p-6 text-center text-gray-500">
            ...
            <p className="mt-1">Start logging your eco-friendly actions!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  {activity.co2Saved && activity.co2Saved > 0 && (
                    <p className="text-xs text-gray-500">{activity.co2Saved}kg CO₂</p>
                  )}
                </div>
              </div>
            ))}
